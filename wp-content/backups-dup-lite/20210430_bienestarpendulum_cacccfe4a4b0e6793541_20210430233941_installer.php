...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20210430_bienestarpendulum_cacccfe4a4b0e6793541_20210430233941_archive.zip';
	const ARCHIVE_SIZE		 = '29474477';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = 'cacccfe-30233941';
    const SECONDARY_PACKAGE_HASH = '98ae313-30233941';
	const VERSION			 = '1.4.0';
